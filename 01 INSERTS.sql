...
START TRANSACTION ;
    ...
    INSERT INTO Jugador (nombre, apellido, nacimiento, numCamiseta, idPais, idPosicion)
        VALUES  -- Argentina
                ...
                ('Moises', 'Ramírez', '2000-09-09', 22, 13, 1),
                ('Alexander', 'Domínguez', '1987-06-05', 22, 13, 2),
                ('Félix', 'Torres', '1997-01-11', 4, 13, 2),
                ('Piero', 'Hincapie', '2002-01-09', 13, 13, 2),
                ('Robert', 'Arboleda', '1991-10-22', 3, 13, 2),
                ('William', 'Pacho', '2001-10-16', 14, 13, 2),
                ('Pervis', 'Estupiñán', '1998-01-21', 6, 13, 2),
                ('Xavier', 'Arreaga', '1994-09-28', 13, 13, 2),
                ('Angelo', 'Preciado', '1998-02-18', 16, 13, 2),
                ('Diego', 'Palacios', '1999-07-12', 2, 13, 2),
                ('Jackson', 'Porozo', '2000-08-04', 23, 13, 2),
                ('José', 'Cifuentes', '1999-03-12', 15, 13, 3),
                ('Carlos', 'Gruezo', '1995-04-19', 20, 13, 3),
                ('Eduar', 'Preciado', '1994-07-28', 10, 13, 3),
                ('Romario', 'Ibarra', '1994-09-24', 11, 13, 3),
                ('Angel', 'Mena', '1988-01-21', 7, 13, 3),
                ('Jeremy', 'Sarmiento', '2002-06-16', 17, 13, 3),
                ('Gonzalo', 'Plata', '2000-11-01', 8, 13, 3),
                ('Jhegson', 'Méndez', '1997-04-26', 5, 13, 3),
                ('Alan', 'Franco', '1998-08-21', 18, 13, 3),
                ('Moisés', 'Caicedo', '2001-11-02', 21, 13, 4),
                ('Michael', 'Estrada', '1996-04-07', 11, 13, 4),
                ('Enner', 'Valencia', '1989-11-04', 13, 13, 4),
                ('Djorkaeff', 'Reasco', '1999-01-18', 19, 13, 4),
                ('Kevin', 'Rodriguez', '2000-03-04', 9, 13, 4),
                -- Gales
